...
print(f"✅ Loaded YOLOv5s with {len(names)} classes")
...
# Load the pretrained YOLOv5s model directly via torch.hub
model = torch.hub.load('ultralytics/yolov5', 'yolov5s', pretrained=True) # Load the model here
model.eval()  # set to inference mode
...
# ✅ STEP 1: ZIP the entire content folder
